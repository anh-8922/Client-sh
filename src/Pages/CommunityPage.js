...
export default function CommunityPage() {
    ...
    const { data, error, refetch } = useFetchData("https://settlers-hub-server.vercel.app/community/listpost" )
  ...
  const handleDeletePost = async (_id) => {
    ...
    try {
      const response = await axios.delete(`https://settlers-hub-server.vercel.app/community/delete/${_id}`, {
  ...
  const handleLikePosts = async (_id) => {
    ...
    try{
      const response = await axios.put('https://settlers-hub-server.vercel.app/community/like',{ _id},{
        withCredentials: true,
        headers: {
