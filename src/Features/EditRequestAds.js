...
export default function EditRequestAds() {
  ...
  const {data, error} = useFetchData(`https://settlers-hub-server.vercel.app/servicerequests/listoneservicerequset/${id}`)
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
        ...
        try {
          const response = await axios.put(`https://settlers-hub-server.vercel.app/servicerequests/edit/${id}`, 
          {
            category: category,
            subject: subject,
            location: location,
