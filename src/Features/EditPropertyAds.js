...
export default function EditProperties() {
  ...
  const {data, error} = useFetchData(`https://settlers-hub-server.vercel.app/housing/listoneproperty/${id}`)
  ...
  const handleSubmit = async (e) => {
    ...
    const formData = new FormData()
        ...
        try {
          const response = await axios.put(`https://settlers-hub-server.vercel.app/housing/edit?id=${id}`, formData, {
